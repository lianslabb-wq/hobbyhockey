      ...
      <div className="space-y-8 text-ice-muted leading-relaxed">
        ...
        <section className="text-center pt-6 border-t border-rink-border">
          ...
          <a
            ...
            className="inline-block px-6 py-3 bg-jersey-blue text-puck font-semibold rounded text-sm uppercase tracking-wider hover:bg-jersey-blue-light transition-colors no-underline"
          >
